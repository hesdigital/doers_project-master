...
class PekerjaanMenungguScreen extends StatefulWidget {
  @override
  _PekerjaanMenungguScreenState createState() => _PekerjaanMenungguScreenState();
}

class _PekerjaanMenungguScreenState extends State<PekerjaanMenungguScreen> {
  ...
  void initState() {
    ...
    super.initState();
    _getDatabase.getListPekerjaanMenunggu(_listPekerjaan, _userEmail);
  }
